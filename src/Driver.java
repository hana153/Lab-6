 ...
 * Lab 6
 *
 * Driver class that creates some shapes and demonstrates how sorting is
 * accomplished through use of the defined natural ordering of shapes (compareTo
 * in Shape) and an alternate order (compare in
 * ShapeAreaComparator/ShapePerimeterComparator).
 *
 * @author Stephen
 * @version 2019-02-18
 */
...
{
    /**
     * Method used to do high-level testing of your code. You may alter this as you
     * see fit.
     * 
