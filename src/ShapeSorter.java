 ...
 *
 * Sorting is done either through the natural ordering of shapes or through a
 * given comparator.
 *
 * @author Stephen
 * @version 2019-02-17
...
public class ShapeSorter
{
    ...
    /**
     * Sort the list of shapes by some custom ordering (a class implementing
     * Comparator<Shape>).
     *
     * It is recommended that you use Collections.sort().
     *
     * @param comparator The shape comparing object that defines the ordering of the
     *                   shapes (how to sort them).
     */
