 ...
 *
 * Specifically, defines a quadrilateral with exactly one pair of parallel
 * sides. This is important to being able to consistently define an area
...
{
    /**
     * The variables storing the lengths of the left/right sides of the trapezoid
     * and the lengths of the top/bottom bases.
     */
    private double leftSide, rightSide, topBase, bottomBase;

    /**
     * The rectangle constructor. Store the side and base information and store in
     * the sideLengths array.
     *
     ...
     * @param topBase    The top base (parallel to the bottom base) of the
     *                   trapezoid.
