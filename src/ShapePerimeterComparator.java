 ...
 * of perimeter. The area is ignored.
 *
 * @author Stephen
 * @version 2019-02-17
 */
public class ShapePerimeterComparator implements Comparator<Shape>
{
     ...
     * order of increasing perimeter, disregarding the area of the shapes.
     *
     ...
     *         (1) Perimeter of s1 is < perimeter of s2: return -1 (2) Perimeter of
     *         s1 is > perimeter of s2: return 1 (3) Perimeter of s1 = perimeter of
     *         s2:
     */
    @Override
    ...
    /**
     * Compares two shapes to determine if they are effectively equal (same
     * perimeter). You should use the compare() method of this class to determine
     * this.
     *
     * @param s1 The first shape to be compared.
     * @param s2 The second shape to be compared.
